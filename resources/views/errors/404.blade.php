...
<head>
    ...
    <title>Halaman Tidak Ditemukan (404) | Panama Corner</title>
...
<body class="bg-slate-50 text-slate-800 min-h-screen flex items-center justify-center p-6">
    <div class="max-w-md w-full bg-white border border-slate-100 rounded-3xl p-8 shadow-xl shadow-slate-200/50 text-center space-y-6">
        <div class="w-16 h-16 bg-amber-50 rounded-full flex items-center justify-center text-amber-500 text-3xl mx-auto">
            🔍
        </div>
        <div class="space-y-2">
            <h1 class="text-xs font-bold uppercase tracking-wider text-amber-600">Error 404</h1>
            <h2 class="text-2xl font-extrabold text-slate-900 leading-tight">Halaman Tidak Ditemukan</h2>
            <p class="text-sm text-slate-500 leading-relaxed pt-2">
                Maaf, alamat URL atau halaman yang Anda cari tidak tersedia, telah dihapus, atau dipindahkan.
            </p>
        </div>
